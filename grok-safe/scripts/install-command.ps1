...
Write-Host '  grok-safe                                  # open current workspace'
Write-Host '  grok-safe -w "V:\project"                  # open a selected workspace'
Write-Host '  grok-safe -w "V:\project" -r <id>          # resume a session in that workspace'
Write-Host '  grok-safe -r <id>                          # resume in the current workspace'
Write-Host '  grok-safe mcp doctor                       # forward normal Grok CLI arguments'
Write-Host ''
Write-Host 'Optional short alias: gsafe'
